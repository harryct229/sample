...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "master_podcasts", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.integer "slave_count", null: false
  ...
  create_table "slave_podcast_index_podcasts", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "podcast_id"
    t.integer "podcast_index_id", null: false
    t.binary "name", size: :long, null: false
    t.binary "artist_name", size: :long, null: false
    t.binary "description", size: :long
    t.string "owner_email", limit: 200
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "apple_podcast_id", limit: 50
    t.index ["apple_podcast_id"], name: "slave_podca_apple_p_f78182_idx"
    t.index ["podcast_id"], name: "slave_podca_podcast_f67db8_idx"
    t.index ["podcast_index_id"], name: "podcast_index_id", unique: true
    t.index ["podcast_index_id"], name: "slave_podca_podcast_198eea_idx"
  end
